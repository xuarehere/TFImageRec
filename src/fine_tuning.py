...
def main():
    ...
    images = tf.placeholder(tf.float32,[None,299,299,3],name='input_image')
    ...
    with tf.Session as sess:
        ...
        for i in range(STEPS):
            _,loss = sess.run([train_step,total_loss],feed_dict={images:training_images[start:end],labels:training_labels[start:end]})
